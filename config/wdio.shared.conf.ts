...
export const config: WebdriverIO.Config = {
  ...
  exclude: [
    //'./tests/specs/test.gold12.connect-a-broker-account.spec.ts', // DagSite integration
    //'./tests/specs/test.gold21.check-news-and-updates.spec.ts', // Rework filter screen
    "./tests/specs/test.sandbox.spec.ts",
  ],
  //
  // ============
  // Capabilities
